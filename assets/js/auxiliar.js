...
const EXCEL_FILE_PATH = '../assets/Archivos/Finanzas/auxiliar.xlsx';
...
// Espera a que el DOM esté cargado para iniciar el proceso
...
async function loadExcelAndRender() {
    try {
        ...
        // Itera sobre los datos del Excel para llenar la tabla y los arrays de datos
        for(let i=0; i<12; i++){
        ...
        // Actualiza los totales en la tabla y en el panel anual
        ...
        // Crea los gráficos usando los datos del Excel
        createOrUpdateMonthlyChart(costos, budgets);
        // Pasa el total de 2025 a la función del gráfico anual
    ...
    annualChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [
                ...
                {
                    label: 'Budget 2025',
                    data: [null, null, totalBudget2025], // El presupuesto de 2025 es el único que cambia
                    type: 'line',
                    borderColor: '#e74c3c',
                    borderWidth: 2,
                    fill: false,
